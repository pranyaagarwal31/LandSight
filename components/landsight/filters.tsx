...
export function ProjectFilters({ projects, extended = false, risk = false, date = false }: { projects: Project[]; extended?: boolean; risk?: boolean; date?: boolean }) {
  const { filters, setFilters, resetFilters } = useWorkspace()
